...
docs/                              roadmap and tracked issues
...
- [Tracked issues](docs/issues.md)
- [Roadmap](docs/roadmap.md)
- [Market data service notes](market-data-service/README.md)

## Security Notes

- The app intentionally does not include authentication because it is designed for personal/local self-hosted use.
- Do not expose the API directly to the public internet unless you place it behind your own access control, VPN, private network, or similar protection.
- Keep `.env`, user secrets, database dumps, and backup files out of git.
- Review external market data provider terms before public or commercial use.
