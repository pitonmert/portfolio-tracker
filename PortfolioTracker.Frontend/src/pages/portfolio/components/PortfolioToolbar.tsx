...
import {
  ...
  type FilterType,
  type SortType,
} from "@/pages/portfolio/portfolioControls";
...
const styles = {
  ...
  searchWrapper:
    "flex h-10 min-w-[72px] flex-1 shrink items-center rounded border border-[color:var(--line)] bg-[var(--bg)] transition-colors focus-within:border-[color:var(--accent)] text-sm",
  searchInput:
