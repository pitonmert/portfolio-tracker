...
const styles = {
  ...
  title:
    "pl-2 truncate font-[family-name:var(--font-display)] text-xl font-bold leading-tight text-[var(--ink)]",
  closeBtn:
...
// ... (LoadingState, ErrorState, EmptyState fonksiyonları aynı) ...
...
// ... (ModalContentProps ve ModalContent aynı) ...
...
export default function AssetHistoryModal({
  ...
  const {
    ...
    error,
    refetch,
  } = useAsync(() => transactionService.getAll({ symbol }), [symbol]);
